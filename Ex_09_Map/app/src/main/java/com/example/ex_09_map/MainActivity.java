...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlaces.add(new MyPlace("우리집",37.33136309999994,126.8598159999993, Color.RED));
        mPlaces.add(new MyPlace("중앙역", 37.31603609999978, 126.83478969999966, Color.BLUE));
        mPlaces.add(new MyPlace("막국수 맛집", 37.32200799999989, 126.85367179999959, Color.YELLOW));
