...
public class MainActivity extends AppCompatActivity {
    ...
    float mRotateFactorX = 0f;
    float mRotateFactorY = 0f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGestureDetector = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener(){
            ...
            public boolean onDoubleTap(MotionEvent event) {
                ...
                Log.d("DoubleClick!", event.getX()+", "+event.getY());
                return true;
            }
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2,
                ...
                if(isModelInit) {
                    ...
                    mRotateFactorX += -distanceX/5;
                    mRotateFactorY += -distanceY/5;
                ...
                if(mTouched) {
                    ...
                    for(HitResult result:results) {
                        ...
                        if (!isModelInit) {
                            ...
                            Matrix.rotateM(modelMatrix, 0, mRotateFactorX, 1f, 1f, 0f);
                            Matrix.scaleM(modelMatrix, 0,
                ...
                if (mCatched){
                    ...
                    for(HitResult result:results) {
                        ...
                        if (catchCheck(pose.tx(), pose.ty(), pose.tz())) {
                            msg = "잡았쥐~?" + pose.tx() + "," + pose.ty() + "," + pose.tz();
                            break;
                        }
                    }
